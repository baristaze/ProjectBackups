...
namespace YummyZone.VenueAdmin.Web
{
    public abstract class YummyZoneHttpHandler : IHttpHandler
    {
        ...
        protected Guid GetMenuId(HttpContext context, Source source)
        {
            return GetMandatoryGuid(context, "mid", "Menu Id", source);
        }

        protected Guid GetMenuCategoryId(HttpContext context, Source source)
        {
            return GetMandatoryGuid(context, "mcid", "Menu Category Id", source);
        }

        protected Guid GetMenuItemId(HttpContext context, Source source)
        {
            return GetMandatoryGuid(context, "miid", "Menu Item Id", source);
        }
        ...
        protected bool GetDeleteOrDisableAction(HttpContext context, Source source)
        {
            ...
            {
                throw new YummyZoneArgumentException("Invalid Action Type: " + action, "act");
            }
