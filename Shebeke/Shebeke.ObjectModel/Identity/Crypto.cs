...
namespace Shebeke.ObjectModel
{
    public class Crypto
    {
        ...
        public static string EncryptAES(string plainText, string secretKey, string iv)
        {
            ...
            {
                throw new ShebekeException("Text to enctrypt is null or empty");
            }

            if (String.IsNullOrWhiteSpace(secretKey))
            {
                throw new ShebekeException("Key to be used in AES is null or empty");
            }

            if (String.IsNullOrWhiteSpace(iv))
            {
                throw new ShebekeException("IV to be used in AES is null or empty");
            }
            ...
            {
                throw new ShebekeException("Encryption returned null");
            }
        ...
        public static string DecryptAES(string cipherText, string secretKey, string iv)
        {
            ...
            {
                throw new ShebekeException("Cypher Text to dectrypt is null or empty");
            }
            ...
            {
                throw new ShebekeException("Decryption returned null or empty");
            }
