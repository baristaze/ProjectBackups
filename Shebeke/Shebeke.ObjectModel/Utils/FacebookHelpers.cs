...
namespace Shebeke.ObjectModel
{
    ...
    {           
        ...
        public static FacebookUser GetUserFromFacebook(string accessToken, long? fbUserIdToCompare)
        {
            ...
            {   
                ...
                if (fbUserIdToCompare.HasValue)
                {
                    ...
                    {
                        throw new ShebekeException("Facebook userId doesn't match");
                    }
                }
            ...
            {
                throw new ShebekeException("We couldn't get the user info from Facebook");
            }
        }
        ...
        public static NameIdPairList GetFriendsListFromFacebook(string accessToken)
        {
            ...
            {
                throw new ShebekeException("We couldn't get the user's friends from Facebook");
            }
        }
        ...
        protected static dynamic FacebookGetCall(string graphPath, string accessToken)
        {
            ...
            {
                throw new ShebekeAuthException("Facebook AuthToken is not valid or expired.", e);
            }
            catch (FacebookApiLimitException e)
            {
                throw new ShebekeException("Facebook API call limit is reached. Try again later.", e);
            }
            catch (FacebookApiException e)
            {
                throw new ShebekeException("Unknown Facebook API exception.", e);
            }
