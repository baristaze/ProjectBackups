...
{
    public abstract class ShebekeHttpHandlerJson<TResponse> : ShebekeHttpHandler where TResponse : BaseResponse, new()
    {
        ...
        public override void ProcessRequest(HttpContext context)
        {
            ...
            catch (SqlException ex)
            {
                ...
                response.ErrorMessage = "Beklenmeyen veritabanı hatası! Oluyor bazen!";
            }
            catch (Exception ex)
            {
                string errorLog = String.Format(
                ...
                response.ErrorMessage = "Beklenmeyen bir hata oluştu! Sorun bizde!";
            }
