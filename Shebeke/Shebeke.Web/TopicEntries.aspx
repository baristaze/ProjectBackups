<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopicEntries.aspx.cs" Inherits="Shebeke.Web.TopicEntries" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#" xml:lang="tr" lang="tr">
<head>
...
<!-- End of Google Analytics Content Experiment code -->
    ...
    <link rel="stylesheet" type="text/css" href="<%=Request.ApplicationPath.TrimEnd('/') + "/Styles/Entry.css?version=0.9851" %>" />
    ...
    <% if (HttpContext.Current.IsDebuggingEnabled) { %>
        ...
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/Base64.debug.js?version=0.985" %>" ></script>
        ...
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/Voting.debug.js?version=0.98541" %>" ></script>
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/Reacting.debug.js?version=0.9854" %>" ></script>
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/ImageUpload.debug.js?version=0.9853" %>" ></script>
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/EntryPreview.debug.js?version=0.985" %>" ></script>
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/EntryAddGetDelete.debug.js?version=0.985" %>" ></script>
        ...
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/Sharing.debug.js?version=0.98541" %>" ></script>
    ...
    <script type="text/javascript">
        ...
        function entryPage_InitFacebookEx() {
           <% if (HttpContext.Current.IsDebuggingEnabled) { %>
           initFacebook('164591543732009', onAuthStateChanged, onServerAuthDefault);
           <% } else { %>
           initFacebook('493048124120847', onAuthStateChanged, onServerAuthDefault);
           <% } %>
        }
    ...
    <div class="page">
        <div id="content" class="content">
                ...
                <div class="mb-inner">
                    <div class="tpc">
                        ...
                        <div class="topic-word txt-xlr txt-title">
                            <span id="topicTitle" runat="server">Başlık bulunamadı</span>
                            <span id="topicDelete" runat="server" class="del-lnk act txt-sml rnd-crn">&larr; sil</span>
                            <div class="topic-acts hidden">
                                <div class="topic-act tag-lnk act txt-med rnd-crn" title="follow this topic">Takip Et</div>
                            </div>
                        </div>
                        <div class="desktop-only hidden">
                            <span class="clr-txt-sub txt-med">Farklı olarak bkz:</span>
                            <span class="dcat act txt-med clr-txt-flu">tv dizisi</span>
                            <span class="dcat act txt-med clr-txt-flu">kitap</span>
                            <span class="dcat act txt-med clr-txt-flu">kafé</span>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
            ...
            <div class="main-block entry-add hidden">
                ...
                <div class="mb-inner brdT">
                    <div class="entry-add-advertise">
                        <div id="entryAddEncourageBeFirst" class="entry-add-encourage be-first hidden">Bu konu hakkında ilk yazan sen ol!</div>
                        <div id="entryAddEncourageNoFirst" class="entry-add-encourage no-first">Sesini duyur!</div>
                    ...
                    <div class="entry-add-btn-wrp">
                            ...
                            <div class="photo-upload-input-wrp shadow bbox hidden">
                                ...
                                <div class="after-special-border bbox">
                                    ...
                                    <form class="photo-upload-form" action="">
                                        <input name="IsLocalFile" class="photo-upload-choice bbox" type="radio" checked="checked" value="0"/><span class="photo-upload-choice-text txt-sml">internetteki bir resmin web linkini kullan</span>
                                        <input name="IsLocalFile" class="photo-upload-choice bbox" type="radio" value="1" /><span class="photo-upload-choice-text txt-sml">bilgisayar veya telefonundan aktar</span>
                                        ...
                                        <button class="btn-soft photo-upload-do-btn bbox">yükle</button>
                                        <div class="clear"></div>
                        ...
                        <button class="entry-add-btn act rnd-crn txt-med">+ ekle</button>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="main-block spinner-block hidden">
                <div class="mb-inner spinner-block-inner">
                    ...
                    <br/>
                    <span class="txt-sml clr-txt-flu">kayıtları yüklüyor</span>
                </div>
                <div class="clear"></div>
            </div>
                ...
                <div class="mb-inner brdT">
                    <div class="last-add-inn brdT brdB">
                        ...
                        <div class="entry-add-btn-wrp">
                            <div class="photo-upload-section">
                                ...
                                <div class="photo-upload-input-wrp shadow bbox hidden">
                                    ...
                                    <div class="after-special-border bbox">
                                        <button class="mini-cross-btn cancel-upload-btn bbox"></button>
                                        <form class="photo-upload-form" action="">
                                            <input name="IsLocalFile" class="photo-upload-choice bbox" type="radio" checked="checked" value="0"/><span class="photo-upload-choice-text txt-sml">bir resmin web linkini kullan</span>
                                            <input name="IsLocalFile" class="photo-upload-choice bbox" type="radio" value="1" /><span class="photo-upload-choice-text txt-sml">bilgisayar veya telefondan aktar</span>
                                            <input class="photo-upload-input photo-upload-input-url bbox" type="text" name="WebFileUrl"/>
                                            <input class="photo-upload-input photo-upload-input-file bbox hidden" type="file" name="LocalFile" />
                                            <button class="btn-soft photo-upload-do-btn bbox">yükle</button>
                                            <div class="clear"></div>
                            ...
                            <button class="entry-add-btn act txt-med">+ ekle</button>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
            ...
            <div class="main-block invite-block">
                ...
                <div class="mb-inner">
                    <div id="topicInvite" class="topic-invite topic-invite-big hidden">
	                    <div class="invite-friends-to-topic txt-lrx3 rnd-crn-big">Arkadaşlarını katkıda bulunmaya davet et!</div>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div id="helper" class="helper">
            <div class="helper-inner">
                <div id="relatedTopicsTitle" class="related-word txt-xlr txt-subt hidden">Tavsiye Edilenler</div>
                <ul class="related">
                </ul>
                <div id="topicInviteSide" class="topic-invite topic-invite-side brdT brdB bkg1 hidden">
                    <div class="invite-friends-side-link">Arkadaşlarını Shebeke'ye Davet Et</div>
                </div>
            </div>    
        </div>        
    </div>
        ...
        <div class="dialog confirm-dialog hidden">
            ...
            <div class="dialog-content confirm-dialog-content">
                ...
                <div class="confirm-dialog-buttons">
                    <button class="confirm-dialog-btn-no rnd-crn txt-lrx">Hayır</button>
                    <button class="confirm-dialog-btn-yes rnd-crn txt-lrx">Evet</button>
                </div>
            </div>
        </div>
        ...
        <div class="dialog install-dialog strong-modal hidden">
            ...
            <div class="dialog-content install-dialog-content">
                <div class="install-dialog-top brdB">
                    <div class="logo-big txt-logo-big table-cell-wrapper"><div class="logo-inner-big">shebeke</div></div>
                    <div class="table-cell-wrapper intall-dialog-curiosity-wrp">
                        <span class="intall-dialog-curiosity clr-txt-reg split-intall-dialog-curiosity">Arkadaşlarının neler paylaştığını merak ediyor musun?</span>
                    </div>
                </div>
                <div class="install-dialog-mid">
                    ...
                    <div class="pg13-txt-wrp table-cell-wrapper txt-sml clr-txt-reg split-pg13-txt-wrp">
                        <span class="pg-13-warning desktop-only split-pg-13-warning-desktop">13 yaş sınırlaması var!<br/>Bu içerik çocuklar için uygun olmayabilir. Yaşınızı teyid için lütfen giriş yapın.</span>
                        <span class="pg-13-warning mobile-only split-pg-13-warning-mobile">13 yaş sınırı var! Yaşını teyid için giriş yap.</span>
                    </div>
                </div>
                <div>
       ...
       <div id="newTopicDialog" class="dialog new-topic-dialog hidden">
        ...
        <div class="main-block entry-block">
            <div class="mb-aux1 entry-aux1">
                <button class="btn-togl-excl-soft vote txt-med" title="oy ver" value="1">+1</button><br/>
                <button class="btn-togl-excl-soft vote txt-med" title="oy ver" value="-1">-1</button><br/>

                <button class="btn-share-entry-facebook rnd-crn desktop-only" title="Facebook'da paylaş">
                ...
                <button class="btn-share-entry-twitter rnd-crn desktop-only" title="Twitter'da paylaş">
                    <img class="share-entry-twitter-img" alt="T" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Images/twitter-small.png" %>" />
                </button><br class="desktop-only"/>
                
                <button class="entry-change-mini-btn entry-edit-mini-btn txt-med rnd-crn mobile-only hidden" title="bu kaydı sil">...</button>
                <button class="entry-change-mini-btn entry-delete-mini-btn txt-med rnd-crn mobile-only hidden" title="bu kaydı sil">x</button>
            </div>
            <div class="mb-aux2 entry-aux2">
                <a href="" class="user-img-link">
                    <img class="user-img act brd" alt="" src="" title="bu yazarın diğer paylaşımlarını gör"/><br/>
                </a>
                
                <button class="btn-share-entry-facebook btn-share-entry-fb2 rnd-crn mobile-only" title="Facebook'da paylaş">
                    <img class="share-entry-facebook-img" alt="F" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Images/facebook-small.png" %>" />
                </button>
                
                <button class="btn-share-entry-twitter btn-share-entry-tw2 rnd-crn mobile-only" title="Twitter'da paylaş">
                    <img class="share-entry-twitter-img" alt="T" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Images/twitter-small.png" %>" />
                </button>
                
                <button class="entry-change-btn entry-edit-btn desktop-only hidden" title="edit this entry">&larr; düzenle</button>
                <button class="entry-change-btn entry-delete-btn desktop-only hidden" title="bu kaydı sil">
                    &larr; sil
                </button>
            </div>
            <div class="mb-inner mb-inner-entry brdT brdB">
                <div class="entry">
                    ...
                    <div class="vote-result txt-sml clr-txt-flu">
                        ...
                        <span class="data-me-current">Henüz oy vermediniz!</span>
                        <img class="act-busy hidden" alt="..." src="<%=Request.ApplicationPath.TrimEnd('/') + "/Images/spinner.gif" %>" />
                        <span class="act-busy hidden">kaydediliyor...</span>
                        <span class="act-done hidden">Başarıyla kaydedildi!</span>
                    </div>
                    <div class="reactions-result txt-sml clr-txt-flu">
                        <span class="data-all-current all-reactions"></span>
                        <span class="act-busy hidden right">&nbsp;kaydediliyor...</span>
                        ...
                        <span class="act-done hidden right">Başarıyla kaydedildi!</span>
                    </div>
                </div>
            </div>
            <div class="clear"></div>
        ...
        <div id="customFacebookDialog"> 
            <div id="facebookSelectAllFriendsArea">
                ...
                <div id="facebookFriendsSelectAllLabel" >Hepsini Seç</div>
                <div id="facebookFriendsFilterPane">
                    <div id="facebookFriendsShowLabel">Göster: </div>
                    <div id="facebookFriendsShowAll" class="facebookFriendsCurrentFilter">Hepsi</div>
                    <div id="facebookFriendsShowOnlySelecteds">Seçili Olanlar</div>
                </div>
            </div>
            <div id="facebookFriendSearchArea">
                <div id="facebookFriendSearchWaterMark">
                    <input id="facebookFriendSearchDescr" type="text" value="İsim Ara..." />
            ...
            <div class="dialog-content compare-entries-dlg-content rnd-crn-big">
                <div class="comparison-title-block brdB">
                    <div class="comparison-title-block-inner">
                        ...
                        <div class="table-cell-wrapper">
                            <div class="comparison-title txt-title txt-lrx3">En iyi paylaşımları seçmemize yardımcı olun</div>
                        </div>
                    </div>
                </div>
                <div class="main-block entry-block entry-block-compare entry-block-compare-left">
                    ...
                    <div class="entry-block-compare-inner entry-block-compare-inner-left">
                        <div class="mb-aux1 entry-aux1 entry-aux1-compare">
                            <button class="btn-soft vote vote-compare txt-med" title="oy ver" value="1">+1</button><br/>
                        </div>
