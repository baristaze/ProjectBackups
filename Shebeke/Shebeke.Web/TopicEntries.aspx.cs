...
{
    public partial class TopicEntries : ShebekeWebPage
    {
        ...
        public string PageTitleForFacebook = "Shebeke";
        ...
        {
            Reaction[] allReactions = Reaction.ReadAll(connection, trans).ToArray();
