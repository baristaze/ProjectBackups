<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionLogs.aspx.cs" Inherits="Shebeke.Web.ActionLogs" %>
                ...
                <div class="row filter-block">
                    <div class="span7">
                        <ul class="nav nav-pills">
                            <li class="log-fetch-size log-fetch-size-20"><a href="javascript:void(0);">Son 20 Log</a></li>
                            <li class="log-fetch-size log-fetch-size-50"><a href="javascript:void(0);">Son 50 Log</a></li>
                            <li class="log-fetch-size log-fetch-size-100"><a href="javascript:void(0);">Son 100 Log</a></li>
                            <li class="log-fetch-size log-fetch-size-200"><a href="javascript:void(0);">Son 200 Log</a></li>
                        </ul>                        
                    </div>
                    <div class="span2">
                        <button class="btn btn-info pull-right button-refresh" type="button"><i class="icon-refresh icon-white the-refresh-icon"></i>Yenile</button>
                    </div>                    
                </div>
            </div>     
        </div>
                        ...
                        <table class="table table-hover table-condensed act-log-table">
                            ...
                            <tbody>
                                <asp:Repeater id="activityLogTableRepeater" runat="server">
		                            ...
		                            <tr class='<%#DataBinder.Eval(Container.DataItem, "ActionTypeColorClass")%>'>
                                        ...
                                        <td class="act-log-user-photo">
                                            <img src='<%#DataBinder.Eval(Container.DataItem, "PhotoUrl")%>' class="act-log-user-img" alt='...' title="Yazarın Facebook sayfasına git" />
                                        </td>
	                            ...
	                            <tr>
                                    ...
                                    <td class="act-log-user-photo">
                                        <img src="/Images/user.png" class="act-log-user-img img-rounded" alt='...' title="Yazarın Facebook sayfasına git" />
                                    </td>
                                    <td class="act-log-user-name">
