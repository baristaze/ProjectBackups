...
function reactingSucceededEx(btn, reactionId, resultArea) {
    return function reactingSucceeded(response, statusText, xhr, $form) {
        ...
        if (statusText == "success") {
            ...
            reactingFailedEx(btn, reactionId, resultArea, "Yorumunuz kaydedilirken beklenmeyen bir hata oluştu!")();
        }
    }        // core 
}  // closure function
...
function sendReaction(btn, reactionId) {
    ...
    $.ajax({
        ...
        error: reactingFailedEx(btn, reactionId, resultArea, "Yorumunuz kaydedilirken beklenmeyen bir hata oluştu!")
    });
