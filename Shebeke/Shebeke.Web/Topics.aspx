<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Topics.aspx.cs" Inherits="Shebeke.Web.Topics" %>
...
<!-- End of Google Analytics Content Experiment code -->
    ...
    <link rel="stylesheet" type="text/css" href="<%=Request.ApplicationPath.TrimEnd('/') + "/Styles/Topics.css?version=0.985" %>" />
    ...
    <% if (HttpContext.Current.IsDebuggingEnabled) { %>
        ...
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/Topics.debug.js?version=0.9852" %>" ></script>
    <% } else { %>
...
<body>
    ...
    <div class="page">
                    ...
                    <div class="main-block topic-block">
                        <div class="mb-aux1 topic-left">
                            <a href="<%#DataBinder.Eval(Container.DataItem, "CreaterActivityLink")%>" class="user-img-link act">
                                <img class="user-img act brd desktop-only" alt="." src='<%#DataBinder.Eval(Container.DataItem, "CreaterPhotoUrl")%>' title="bu yazarın diğer paylaşımlarını gör"/>
                            </a>
                        </div>
                        ...
                        <div class="mb-inner">
                            <div class="topic-box">
                                ...
                                <div class="table-cell-wrapper social-mini facebook-icon-wrp-mini rnd-crn hidden" title="bu başlığı Facebook'da paylaş">
                                    <img class="facebook-icon-img-mini" alt="F" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Images/facebook-small.png" %>" />
                                </div>
                                <div class="table-cell-wrapper">
                                    <div class="social-share-sep"></div>
                                </div>
                                <div class="table-cell-wrapper social-mini twitter-icon-wrp-mini rnd-crn hidden" title="bu başlığı Twitter'da Paylaş">
        ...
        <div id="helper" class="helper">
            <div class="helper-inner">
                <div id="promotedTopicsTitle" class="promoted-topic-title txt-xlr txt-subt">Kısa Bilgiler</div>
    ...
    <!--an old trick to let the search engine crawlers hit the welcome page-->
    <!--welcome page has hidden links to newly added topics, which helps SEO-->
    <div class="hidden">
        <a href="<%=Request.ApplicationPath.TrimEnd('/') + "/welcome" %>">welcome page</a>
    </div>
