...
/* TEXT */
EXEC [dbo].[InsertTextSplitters] 1, 1, 'Cover Page - Brand Text', 1, 'logoTextCtrl', 'shebeke';
EXEC [dbo].[InsertTextSplitters] 1, 1, 'Cover Page - Idea Text', 1, 'ideaTextCtrl', 'Sesini duyur! <br/>Shebeke seni dünyaya bağlar.';
EXEC [dbo].[InsertTextSplitters] 1, 1, 'Cover Page - Join Text', 1, 'joinTextCtrl', 'Betaya hemen katıl!';
EXEC [dbo].[InsertTextSplitters] 1, 1, 'Cover Page - Facebook Text', 1, 'signupTextCtrl', 'Facebook ile Bağlan';
...
EXEC [dbo].[InsertTextSplitters] 3, 1, 'Encourage Signup - PG13 Text Desktop', 0, '.split-pg-13-warning-desktop', '13 yaşından büyük müsünüz?<br/>Bu içerik 13 yaşından küçükler için uygun olmayabilir. Lütfen yaşınızı teyid etmek için bağlanın.';
EXEC [dbo].[InsertTextSplitters] 3, 1, 'Encourage Signup - PG13 Text Mobile', 0, '.split-pg-13-warning-mobile', '13 yaşından büyük müsünüz? Teyid etmek için bağlanın.';
...
EXEC [dbo].[UpdateSplitter2] 3, 2, 'Encourage Signup - PG13 Text Desktop', 'Paylaşımda bulunan kişinin, sizin arkadaşınız olduğunu teyid etmemiz gerekiyor. Paylaşımı görebilmek için lütfen bağlanın.';
EXEC [dbo].[UpdateSplitter2] 3, 2, 'Encourage Signup - PG13 Text Mobile', 'Paylaşımı görebilmek için bağlanın.';
...
EXEC [dbo].[InsertTextSplitters] 4, 1, 'Encourage Signup - Title', 0, '.split-intall-dialog-curiosity', 'Arkadaşlarınız hangi konudan mı bahsediyorlar??';
EXEC [dbo].[InsertTextSplitters] 4, 2, 'Encourage Signup - Title', 0, '.split-intall-dialog-curiosity', 'Arkadaşlarınız ne mi dedi??';
EXEC [dbo].[InsertTextSplitters] 4, 3, 'Encourage Signup - Title', 0, '.split-intall-dialog-curiosity', 'Arkadaşlarınız ne mi paylaştı??';
