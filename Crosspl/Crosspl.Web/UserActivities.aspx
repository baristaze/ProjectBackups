<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserActivities.aspx.cs" Inherits="Crosspl.Web.UserActivities" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title id="pageTitle" runat="server">Vizibuzz - User Activities</title>
...
<!-- End of Google Analytics Content Experiment code -->
    ...
    <link rel="stylesheet" type="text/css" href="<%=Request.ApplicationPath.TrimEnd('/') + "/Styles/UserActivities.css?version=0.97" %>" />
    ...
    <% if (HttpContext.Current.IsDebuggingEnabled) { %>
        ...
        <script type="text/javascript" src="<%=Request.ApplicationPath.TrimEnd('/') + "/Scripts/UserActivities.debug.js?version=0.97" %>" ></script>
    <% } else { %>
                ...
                <div class="mb-inner target-user">
                    <div class="table-cell-wrapper">
                        <a id="targetUserFacebookLink" href="" runat="server">
                            <img id="targetUserImage" runat="server" src="" class="act-log-user-img" alt='' title='see user on facebook' />
                        </a>
                    </div>
                    <div class="table-cell-wrapper">
