<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacebookInvite.aspx.cs" Inherits="Crosspl.Web.FacebookInvite" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var options = {
            appId: '133423290166132', // App ID from the App Dashboard
        ...
        function showInvitationSendWindow(topicId, selectedFriendsAll, currentIterationIndex){
            ...
            if(selectedFriendsAll.length > sentSoFar){
                ...
                FB.ui({ method: 'apprequests',
                    message: 'sakin olun, bu sadece bir test!',
                    to: nextFriends,
                    data: topicId
            ...
            $dlg.dialog(
                {
                    buttons:
                    {
                        "SendRequests": { text: 'Send Requests', click: function () { fbInvitationConfirmed($(this), topicId); } },
                        "Cancel": { text: 'Cancel', class: 'facebookInviteCancelButtonClass', click: function () { fbInvitationCancelled($(this), topicId); } }
                    }
                }
            );
