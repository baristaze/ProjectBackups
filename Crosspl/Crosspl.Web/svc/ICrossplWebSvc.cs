...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the interface name "ICrossplWebSvc" in both code and config file together.
    [ServiceContract]
    public interface ICrossplWebSvc
    {
        [OperationContract]
        [WebInvoke(
