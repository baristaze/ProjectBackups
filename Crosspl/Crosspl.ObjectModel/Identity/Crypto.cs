...
namespace Crosspl.ObjectModel
{
    public class Crypto
    {
        ...
        public static string EncryptAES(string plainText, string secretKey, string iv)
        {
            ...
            {
                throw new CrossplException("Text to enctrypt is null or empty");
            }

            if (String.IsNullOrWhiteSpace(secretKey))
            {
                throw new CrossplException("Key to be used in AES is null or empty");
            }

            if (String.IsNullOrWhiteSpace(iv))
            {
                throw new CrossplException("IV to be used in AES is null or empty");
            }
            ...
            {
                throw new CrossplException("Encryption returned null");
            }
        ...
        public static string DecryptAES(string cipherText, string secretKey, string iv)
        {
            ...
            {
                throw new CrossplException("Cypher Text to dectrypt is null or empty");
            }
            ...
            {
                throw new CrossplException("Decryption returned null or empty");
            }
