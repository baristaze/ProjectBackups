    ...
    public class EntryFormatHelper
    {
            ...
            bool includeAuthorInfo)
        {
            ...
            if (includeAuthorInfo)
            {
                ...
                string userIDs = CrossplUtils.ConcatenateIDs(entries, (e) => { return e.CreatedBy; });
                authors = FacebookUser.ReadAllByID(conn, trans, userIDs);
            }

            // get image source of the entries
            string entryIDs = CrossplUtils.ConcatenateIDs(entries);
            ...
            foreach (Entry e in entries)
            {
                ...
                if (includeAuthorInfo)
                {
                    ...
                    FacebookUser author = CrossplUtils.Search(authors, e.CreatedBy);
                    if (author != null)
                    {
