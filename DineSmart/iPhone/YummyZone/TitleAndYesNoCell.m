...
@implementation TitleAndYesNoCell
...
- (void)layoutSubviews 
{
	...
	_switchControl.frame = CGRectMake(LEFT_OFFSET + _titleWidth + TITLE_DETAIL_SEPARATION,
...
{
    [delegate switchValueChanged:_switchControl.on key:_key];
}
