...
@synthesize star, selectedStar, highlightedStar, delegate;
...
- (void)setupView {
	...
	currentIdx = -1;
	star = [[UIImage imageNamed:@"star-nonselected.png"] retain];
    selectedStar = [[UIImage imageNamed:@"star-selected.png"] retain]; 
	highlightedStar = [[UIImage imageNamed:@"star-selected.png"] retain];        
	for (int i=0; i<numberOfStars; i++) {
        
		DLStarView *v = [[DLStarView alloc] initWithDefault:self.star 
                                                   selected:self.selectedStar 
