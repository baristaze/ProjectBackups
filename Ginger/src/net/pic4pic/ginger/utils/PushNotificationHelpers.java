...
public class PushNotificationHelpers {
	...
	public static boolean checkPlayServices(Activity activity) {
	    ...
	    if (resultCode == ConnectionResult.SUCCESS) {
	    	MyLog.v("PushNotificationHelpers", "Google Play Services is available.");
	    	return true;
	    }
	    
	    if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
	    	MyLog.i("PushNotificationHelpers", "Google Play Services is NOT available but error is recovarable.");
            GooglePlayServicesUtil.getErrorDialog(resultCode, activity, PLAY_SERVICES_RESOLUTION_REQUEST).show();
        } 
        else {
        	
        	MyLog.e("PushNotificationHelpers", "This device does not support Google Play Services. Push Notifications won't be received.");
	...
	public static void storeRegistrationId(Activity activity, String registrationId) {
	    ...
	    MyLog.i("PushNotificationHelpers", "Saving push notification registrationId on app version " + appVersion);
	...
	public static String getRegistrationId(Activity activity) {
	    ...
	    if (registrationId.isEmpty()) {
	        MyLog.i("PushNotificationHelpers", "Push notification registration is not found.");
	        return "";
	    }
	    ...
	    if (registeredVersion != currentVersion) {
	        MyLog.i("PushNotificationHelpers", "App version has changed. We need to refresh the push notification registration.");
	        return "";
	    }
